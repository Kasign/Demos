...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  ...
  __Block_byref_b_1 *b = __cself->b; // bound by ref
        ...
        printf("LG_Cooci - %d %d", (a->__forwarding->a), (b->__forwarding->b));
    }
...
int main(){
    ...
    __attribute__((__blocks__(byref))) __Block_byref_b_1 b = {(void*)0,(__Block_byref_b_1 *)&b, 0, sizeof(__Block_byref_b_1), 20};
