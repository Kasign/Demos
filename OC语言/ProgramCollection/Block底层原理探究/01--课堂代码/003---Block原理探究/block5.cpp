...
static void __main_block_func_0(struct __main_block_impl_0 *__cself, int b) {
  __Block_byref_a_0 *a = __cself->a; // bound by ref

        printf("Log - %d %d", b, (a->__forwarding->a));
    }
...
int main(){
    ...
    void(*block)(int) = ((void (*)(int))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, (__Block_byref_a_0 *)&a, 570425344));

    ((void (*)(__block_impl *, int))((__block_impl *)block)->FuncPtr)((__block_impl *)block, 6);
    return 0;
}
