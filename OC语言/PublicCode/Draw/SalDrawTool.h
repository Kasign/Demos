...
@property (nonatomic, assign) CGRect              drawRect;  //绘制区域坐标
@property (nonatomic, assign) CGRect              drawBox;   //如果有旋转这里的值跟drawRect不同
...
/// 要绘制的Buffer任务信息
@interface SalBufferTask : SalDetailDrawTask
...
@property (nonatomic, assign) CGImageRef          drawImageRef;
...
@property (nonatomic, assign) float               opacity;      //整体透明度，对所有都生效
